...
# # Forcing cheaper aircraft here to see if we do better
# idx_flights_0 = [125,126,127,128]
# C16 = stage1.addConstrs((x[a, 0] == 1 for a in idx_flights_0), name="C16")
...
if not os.path.exists(os.path.join(cwd,results_folder_name,folder_name)):
    os.makedirs(os.path.join(cwd,results_folder_name,folder_name))

stage1.setParam('MIPGap', 0.001)
stage1.setParam('TimeLimit',3600)  # seconds
stage1.setParam('LogFile',os.path.join(cwd,logs_folder_name,folder_name+'_SEQ1.log'))
stage1.optimize()

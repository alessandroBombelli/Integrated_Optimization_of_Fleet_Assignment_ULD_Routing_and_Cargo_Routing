...
if not os.path.exists(os.path.join(cwd,"results",folder_name)):
    os.makedirs(os.path.join(cwd,"results",folder_name))

# Define folder to store results of first stage
first_stage_folder = os.path.join(cwd,"results",folder_name,"SEQ","first_stage")
# Define folder to store results of second stage
second_stage_folder = os.path.join(cwd,"results",folder_name,"SEQ","second_stage")
# Make folders
if not os.path.exists(first_stage_folder):
    os.makedirs(first_stage_folder)
if not os.path.exists(second_stage_folder):
    os.makedirs(second_stage_folder)
# Saving first stage solution
x_dict_first_stage = sequential_stage1.x_dict
y_dict_first_stage = sequential_stage1.y_dict
z_dict_first_stage = sequential_stage1.z_dict

# file_name_x_dict_first_stage = "x_dict_first_stage.pkl"
# file_path = os.path.join(first_stage_folder, file_name_x_dict_first_stage)
# with open(file_path, "wb") as file:
#      pickle.dump(x_dict_first_stage, file)

# file_name_y_dict_first_stage = "y_dict_first_stage.pkl"
# file_path = os.path.join(first_stage_folder, file_name_y_dict_first_stage)
# with open(file_path, "wb") as file:
#      pickle.dump(y_dict_first_stage, file)

# file_name_z_dict_first_stage = "z_dict_first_stage.pkl"
# file_path = os.path.join(first_stage_folder, file_name_z_dict_first_stage)
# with open(file_path, "wb") as file:
#      pickle.dump(z_dict_first_stage, file)
...
# Saving second stage solution
file_name_x_dict_second_stage = "x_dict_second_stage.pkl"
file_path = os.path.join(second_stage_folder, file_name_x_dict_second_stage)
with open(file_path, "wb") as file:
     pickle.dump(x_dict, file)

file_name_y_dict_second_stage = "y_dict_second_stage.pkl"
file_path = os.path.join(second_stage_folder, file_name_y_dict_second_stage)
with open(file_path, "wb") as file:
     pickle.dump(y_dict, file)

file_name_z_dict_second_stage = "z_dict_second_stage.pkl"
file_path = os.path.join(second_stage_folder, file_name_z_dict_second_stage)
with open(file_path, "wb") as file:
     pickle.dump(z_dict, file)

# Saving data on requests and ULDs
R_dict_file = os.path.join(cwd,"results",folder_name,"SEQ","R_dict.pkl")
U_dict_file = os.path.join(cwd,"results",folder_name,"SEQ","U_dict.pkl")
N_dict_file = os.path.join(cwd,"results",folder_name,"SEQ","N_dict.pkl")
N_dict_idx_at_file = os.path.join(cwd,"results",folder_name,"SEQ","N_dict_idx_at.pkl")
N_dict_at_idx_file = os.path.join(cwd,"results",folder_name,"SEQ","N_dict_at_idx.pkl")
dict_IATA_idx_file = os.path.join(cwd,"results",folder_name,"SEQ","dict_IATA_idx.pkl")
airports_IATA_file = os.path.join(cwd,"results",folder_name,"SEQ","airports_IATA.pkl")
F_dict_file = os.path.join(cwd,"results",folder_name,"SEQ","F_dict.pkl")
F_info_file = os.path.join(cwd,"results",folder_name,"SEQ","F_info.pkl")
W_fk_file = os.path.join(cwd,"results",folder_name,"SEQ","W_fk.pkl")

with open(R_dict_file, 'wb') as file:
    pickle.dump(R_dict, file)
with open(U_dict_file, 'wb') as file:
    pickle.dump(U_dict, file)
with open(N_dict_file, 'wb') as file:
    pickle.dump(N_dict, file)
...
with open(dict_IATA_idx_file, 'wb') as file:
    pickle.dump(dict_IATA_idx, file)
...
x_dict_first_stage_file = os.path.join(full_folder_path, 'x_first_stage_data.pkl')
y_dict_first_stage_file = os.path.join(full_folder_path, 'y_first_stage_data.pkl')
z_dict_first_stage_file = os.path.join(full_folder_path, 'z_first_stage_data.pkl')
...
with open(x_dict_first_stage_file, 'wb') as file:
    pickle.dump(x_dict_first_stage, file)

with open(y_dict_first_stage_file, 'wb') as file:
    pickle.dump(y_dict_first_stage, file)

with open(z_dict_first_stage_file, 'wb') as file:
    pickle.dump(z_dict_first_stage, file)

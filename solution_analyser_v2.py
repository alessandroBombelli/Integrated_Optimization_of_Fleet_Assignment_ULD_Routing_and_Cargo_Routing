...
name = 'full_L_80_restricted_subset15_5it_w_max_cap200_seed42_CG'
print(f'Name of analysed instance: {name}')

# Specify the file names
x_file_name = 'pickle_files/'+name+'/x_data.pkl'
y_file_name = 'pickle_files/'+name+'/y_data.pkl'
z_file_name = 'pickle_files/'+name+'/z_data.pkl'
...
# )
if "CG" in name:
    p_file_name = 'pickle_files/'+name+'/P_dict.pkl'
